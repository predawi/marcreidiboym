...
function baroque_post_nav() {
	...
	<nav class="navigation post-navigation">
		...
		<div class="nav-links">
			...
			previous_post_link( '<div class="nav-previous">%link</div>', _x( '<span class="meta-nav"><i class="fa fa-chevron-left" aria-hidden="true"></i></span>Précédent', 'Previous post link', 'baroque' ) );

			next_post_link(     '<div class="nav-next">%link</div>', 'Suivant<span class="meta-nav"><i class="fa fa-chevron-right" aria-hidden="true"></i></span>', 'Next post link', 'baroque' ) );
	...
	<nav class="navigation portfolio-navigation">
		...
		<div class="container">
			...
			<div class="nav-links">
				...
				<a class="portfolio-link" href="<?php echo esc_url( get_post_type_archive_link( 'portfolio' ) ); ?>">Tous les projets</a>
